...
export function Header({ theme, toggleTheme }) {
  ...
  //once logout data will be removed from local storage
  const logoutHandler = () => {
    onTokenHandler(null);
    onNameHandler(null);
  ...
  const handleSearchInputChange = (event) => {
    ...
    if (value !== undefined) {
      onSearhDetails({ target: { value } });
      onSearhDetailsAlbum({ target: { value } });
    }
  };
    ...
    <div className="header-container">
      <div className="burger-container">
        ...
        <div ref={menuRef} className={menuClass}>
          <MenuItems closeMenu={closeMenu} theme={theme} toggleTheme={toggleTheme} />
        </div>
      ...
      <div>
        <div className="subscribe">
          <Link className="s-link" to="/subscribe">
            <div className="subscribe-t">Welcome Offer: 1 Month Trial @ ₹1</div>
          </Link>
        </div>
      </div>
      <div className="subscribe-plus">
        <Link className="s-link" to="/subscribe">
          <div className="subscribe-p"> Get Gaana Plus</div>
        </Link>
      </div>
      ...
      <div className="nav-button-cnt">
        {getName && getToken ? (
          <>
            ...
            <Link className="dropdown-item" onClick={logoutHandler} to="/login">
